...
GET /repair-orders?cursor=<token>
9. Filtering
...
bay is available
vehicle is not already occupying incompatible bay
21. Technician Job API
...
49. Offline Synchronisation API
...
POST /sync	authenticated + resource permission
58. Frontend API Client
...
67. Critical Architectural Principle
